...
-- -----------------------------------------------------
-- Table `toy_project`.`SHELTER_TYPE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toy_project`.`SHELTER_TYPE` (
...
CREATE TABLE IF NOT EXISTS `toy_project`.`SHELTER_GPS` (
  ...
  CONSTRAINT `fk_SHELTER_GPS_SHELTER_TYPE_CODE`
    FOREIGN KEY (`SHELTER_CODE`)
    REFERENCES `toy_project`.`SHELTER_TYPE` (`SHELTER_CODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
