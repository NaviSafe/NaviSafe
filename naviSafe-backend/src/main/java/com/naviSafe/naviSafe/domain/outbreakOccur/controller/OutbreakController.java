    ...
    public ResponseEntity<?> getAllOutbreak(){
        ...
        List<OutbreakResponseDto> responseDtoList = outbreakList.stream()
                .map(o -> OutbreakResponseDto.builder()
                        ...
                        .speedLoadTraffic(o.getRoadStatusLink().getRoadStatus().getRoadTraffic().getPrcsSpd())
                        .travelTimeLoad(o.getRoadStatusLink().getRoadStatus().getRoadTraffic().getPrcsTrvTime())
